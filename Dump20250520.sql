...
--
-- Host: 127.0.0.1    Database: opencart_clone
-- ------------------------------------------------------
...
--
-- Table structure for table `oc_smsalert_notify`
--

DROP TABLE IF EXISTS `oc_smsalert_notify`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oc_smsalert_notify` (
...
--
-- Table structure for table `oc_tvcmsblog_comment`
--
...
CREATE TABLE `oc_tvcmsblog_comment` (
  `tvcmsblog_comment_id` int(11) NOT NULL,
  ...
  `tvcmsblog_comment_comment` text DEFAULT NULL,
...
--
-- Table structure for table `oc_tvcmsblog_gallery`
--
...
CREATE TABLE `oc_tvcmsblog_gallery` (
  `tvcmsblog_gallery_id` int(11) NOT NULL,
  `tvcmsblog_id` int(11) NOT NULL,
  `image` varchar(255) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `oc_tvcmsblog_main`
--
...
--
-- Table structure for table `oc_tvcmsblog_sub`
--
...
CREATE TABLE `oc_tvcmsblog_sub` (
  `tvcmsblog_sub_id` int(11) NOT NULL,
  ...
  `tvcmsblog_sub_metatitle` text DEFAULT NULL,
  `tvcmsblog_sub_metatag` text DEFAULT NULL,
  `tvcmsblog_sub_metades` text DEFAULT NULL,
  `tvcmsblog_sub_metakeyword` text DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `oc_tvcmsblogcategory_main`
--
...
--
-- Table structure for table `oc_tvcmsblogcategory_sub`
--
...
CREATE TABLE `oc_tvcmsblogcategory_sub` (
  `tvcmsblogcategory_sub_id` int(11) NOT NULL,
  ...
  `tvcmsblogcategory_sub_metatitle` text DEFAULT NULL,
  `tvcmsblogcategory_sub_metades` text DEFAULT NULL,
  `tvcmsblogcategory_sub_metakeyword` text DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `oc_tvcmsbrandlist`
--
...
CREATE TABLE `oc_tvcmsbrandlist` (
  `tvcmsbrandlist_id` int(11) NOT NULL,
...
CREATE TABLE `oc_tvcmsimageslidersub` (
  `tvcmsimageslidersub_id` int(11) NOT NULL,
  `tvcmsimageslidermain_id` int(11) NOT NULL,
  ...
  `tvcmsimageslidersub_des_main` text DEFAULT NULL,
  `tvcmsimageslidersub_des_sub` text DEFAULT NULL,
...
CREATE TABLE `oc_tvcmsnewsletter` (
  `tvcmsnewsletter_id` int(11) NOT NULL,
...
CREATE TABLE `oc_tvcmspaymenticonsub` (
  `tvcmspaymenticonsub_id` int(11) NOT NULL,
  `tvcmspaymenticonmain_id` int(11) NOT NULL,
...
CREATE TABLE `oc_tvcmssocialiconsub` (
  `tvcmssocialiconsub_id` int(11) NOT NULL,
  `tvcmssocialiconmain_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_tvcmstags`
--

DROP TABLE IF EXISTS `oc_tvcmstags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oc_tvcmstags` (
  `tvcmstags_id` int(11) NOT NULL,
  `tvcmstags_title` varchar(255) DEFAULT NULL,
  `tvcmstags_link` varchar(255) DEFAULT NULL,
  `tvcmstags_pos` int(11) DEFAULT NULL,
  `tvcmstags_status` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oc_tvcmstestimonialsub` (
  `tvcmstestimonialsub_id` int(11) NOT NULL,
  `tvcmstestimonialmain_id` int(11) NOT NULL,
  `tvcmstestimonialsublang_id` int(11) NOT NULL,
  `tvcmstestimonialsub_title` varchar(255) DEFAULT NULL,
  `tvcmstestimonialsub_designation` text DEFAULT NULL,
  `tvcmstestimonialsub_description` text DEFAULT NULL,
  `tvcmstestimonialsub_short_description` text DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `oc_tvcustomlink`
--
...
CREATE TABLE `oc_tvcustomlink` (
  `tvcustomlink_id` int(11) NOT NULL,
...
-- Dump completed on 2025-05-20  8:54:29
